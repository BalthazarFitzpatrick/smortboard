...
ledgers: `TASKS.jsonl` and `WORKLOG.md` live in the private `dev_ledgers` repo
(`../dev_ledgers/smortboard/`, branch `sync`). The root files are untracked, gitignored symlinks

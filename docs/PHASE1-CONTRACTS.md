...
> disagrees with the code or the README, they win. The main differences: ten blocked reason codes, not
> seven (`MERGE_CONFLICT`, `API_UNREACHABLE` and `BASE_RED` joined); many more routes (see
